...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const itemsWithChildren = document
    .querySelectorAll('#block-hdbt-subtheme-main-navigation .menu__item--children');
...
window.addEventListener('click', function (event) {
  ...
  if (document.getElementById('block-hdbt-subtheme-main-navigation').contains(event.target)) {
